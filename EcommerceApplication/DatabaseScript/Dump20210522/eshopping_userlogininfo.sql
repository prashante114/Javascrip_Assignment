...
CREATE TABLE `userlogininfo` (
  `LoginCountID` int NOT NULL AUTO_INCREMENT,
  `UserName` varchar(20) NOT NULL,
  `LoginDateTime` datetime NOT NULL,
  `LogoutDateTime` datetime NOT NULL,
  PRIMARY KEY (`LoginCountID`),
  UNIQUE KEY `UserName` (`UserName`),
  CONSTRAINT `userlogininfo_ibfk_1` FOREIGN KEY (`UserName`) REFERENCES `usermaster` (`UserName`)
...
-- Dump completed on 2021-05-22 14:27:32
