...
CREATE TABLE `usersinrole` (
  ...
  CONSTRAINT `usersinrole_ibfk_1` FOREIGN KEY (`UserName`) REFERENCES `usermaster` (`UserName`)
...
INSERT INTO `usersinrole` VALUES (1,'indrar','Admin'),(2,'dhananjay101','Admin'),(3,'aman101','Vendor'),(4,'dhananjayjoshi114','Customer'),(5,'PrashantJoshi114','Customer');
...
-- Dump completed on 2021-05-22 14:27:34
